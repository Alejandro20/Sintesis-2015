<section>
    ...
    <div class="titol">Editar site:</div>
            ...
            <input type="hidden" name="guardar" value="1" />
          	...
          	<div class="contenedor_column">  
                    ...
                    <div id="imatges">
           			...
           			<input type="button" id="add_img_update" value="Actualitzar Imatge"/>
	...
	<?php else: 
     ...
     <script>
		...
		$(document).ready(function(){ 
			...
			/*Funcio afegir inputs en vista de Actualitzar Lloc*/
			
			$("#add_img_update").click(function(){
